    ...
    <div class="row aboutUsBox">
      <div class="col-md-8">
        ...
        <p class="aboutUsContent">
          ...
          我們認為簡約的設計，能為女性在穿搭上帶來無限可能，
          鼓勵女性大膽挑戰，激發女性由外而內的無限潛力。
        </p>
        ...
        <p class="aboutUsContent">
          ...
          我們提供一個良好的工作環境，每個月有提供一次心理師諮商的服務保護員工並支持維護團隊。
        </p>
        ...
        <img src="@/assets/img/aboutPageD.png" alt="" class="w-100 aboutUsImg">
      </div>
    </div>
  </div>
</template>
