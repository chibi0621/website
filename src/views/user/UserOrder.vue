<template>
  ...
  <div class="my-5 row justify-content-center">
    ...
    <ForM class="col-md-7 orderBox" v-slot="{ errors }"
    @submit="createOrder">
      <h5 class="orderH5">收件者資料</h5>
      ...
      <hr class="fieldBox p-0 mb-5">
      <h5 class="orderH5">運送方法</h5>
      <div class="fieldBox mb-5">
      ...
      <hr class="fieldBox p-0 mb-5">
      <div class="fieldBox mb-5">
          <h5 class="orderH5">備註</h5>
          <textarea name="" id="message" class="form-control" cols="30" rows="5"
          aria-label="Message" v-model="form.message"></textarea>
      </div>
      <div class="fieldBox text-end mb-5">
        <button class="orderBtn" type="submit" @click="goToCheckout()">
          送出訂單
        </button>
      </div>
    </ForM>
