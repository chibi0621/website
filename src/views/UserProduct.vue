<template>
  ...
  <div class="container">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <router-link to="/user/cart" class="cart">
            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="#8c6650"
            class="bi bi-handbag pb-1" viewBox="0 0 16 16">
    ...
    <div class="productDetail row justify-content-center">
      <figure class="col-8">
        <img :src="product.imageUrl" alt="" class="img-fluid mb-3">
      </figure>
      <div class="col-4">
        <h2 class="productName fs-4 mb-3">{{ product.title }}</h2>
